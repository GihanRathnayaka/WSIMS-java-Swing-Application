...
public class UserManagement extends javax.swing.JFrame {
 ...
 public void Show_USers(){
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bw/randiyadahara/wsims/view/Image/Search.png"))); // NOI18N
        jButton1.setText("Search");
        jButton1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jButton1.setPreferredSize(new java.awt.Dimension(141, 57));
      ...
      if(ckSubCommity.isSelected()==true){
       ...
       // int  user_id = Integer.parseInt(txtUserId.getText());
        ...
        if( (txtFName.getText().length()==0)||(txtUerName.getText().length()==0)||(txtPassWord.getText().length()==0)||txtFullName.getText().length()==0){
                ...
                JOptionPane.showMessageDialog(null,"One Or More Fild Not Fild");
    ...
    private void usersTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_usersTableMouseClicked
        ...
        txtUserId.setText(mode.getValueAt(i,0).toString());
    ...
    private void btnUpdateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateMouseClicked
        ...
        try {
            boolean result =UserRoleManagementControler.UpdateUserRole(urm);
              if(result){
              JOptionPane.showMessageDialog(null,"User Roles Change !");
               Show_USers();
               clearFild();
              } else{
              JOptionPane.showMessageDialog(null,"Error!");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        UsersRolsManagement urm =new UsersRolsManagement();
        urm.setUserId(Integer.parseInt(txtUserId.getText()));
        ...
        try {
         ...
         if(result){
             ...
             JOptionPane.showMessageDialog(null,"Romove User !");
