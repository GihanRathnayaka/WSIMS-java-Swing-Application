...
public final class Employee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtCalander.setBackground(new java.awt.Color(102, 153, 255));
        txtCalander.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 14))); // NOI18N
        ...
        txtCalander.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(cmbJobtitle, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addComponent(txtCalander, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel5)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
   ...
   if(txtFullName.getText().equals("")||TxtNic.getText().equals("")||TxtPhone.getText().equals("")||txtCalander.getDate()==null||txtAddress.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(null,"you should fill relavant field.EE");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if(txtFullName.getText().equals("")||TxtNic.getText().equals("")||TxtPhone.getText().equals("")||txtCalander.getDate()==null||txtAddress.getText().equals("")){
            ...
            JOptionPane.showMessageDialog(null,"Fill Relevent Fild");
            if(TxtNic.getText().equals("")){   TxtNic.setBackground(Color.PINK);
            }else{
            TxtNic.setBackground(Color.white);
            }
    ...
    try {
           ...
           JOptionPane.showMessageDialog(null,"Udated Employee Details ! ");
           viewEmployees();
           TxtNic.setBackground(Color.WHITE);
           TxtPhone.setBackground(Color.WHITE);
           txtFullName.setBackground(Color.WHITE);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            if(result){
                JOptionPane.showMessageDialog(null,"Remove The Employee !");
                viewEmployees();
                btnClear.doClick();
            }else{
