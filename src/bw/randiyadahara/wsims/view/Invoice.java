...
public final class Invoice extends javax.swing.JFrame {
   ...
   public void loadAllInvoice(){
     ...
     public  void  setCustomerDetails(int month,int Year,String CusNo ){
       Invoices i=null;
        try {
            ...
            JOptionPane.showMessageDialog(null, "No Record ! Please Check ");
    ...
    private void initComponents() {
        ...
        jLabel17.setText("Meter Read Day");
        ...
        jLabel27.setText("Price For Comsuption Units");
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addComponent(lblAddiSearvicePrice, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jLabel41, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addComponent(jLabel17, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
                                            ...
                                            .addComponent(jLabel26, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    ...
                                    .addComponent(jLabel31, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
            ...
            i.setUpdateDate(createdDate);
                ...
                try {
                    ...
                    if(result){
                        JOptionPane.showMessageDialog(null, "Invoice Deteted !");
                        btnClear.doClick();
                    }else{
  ...
  DefaultTableModel model = (DefaultTableModel) tblLine.getModel();
    ...
    if(txtCusNo.getText().trim().equals("")||txtCuName.getText().trim().equals("")||txtInvAmount.getText().trim().equals("")||txtBillPrice.getText().equals("")||Idate.getDate()==null){
      ...
      if(year==y && month==m ){
          ...
          JOptionPane.showMessageDialog(null," Sorry All Ready Invoiced  ! ");
          btnClear.doClick();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if(rbIsPaid.isSelected()||N.equals("Y")){
            ...
            JOptionPane.showMessageDialog(null,"Sorry You Can't Modify Record Because Invoice Allready Paid !");
            btnClear.doClick();
            return;
        }else{
                ...
                try {
                    ...
                    if(result){
                          ...
                          JOptionPane.showMessageDialog(null, " Updated For The Selected Month ");
                          btnClear.doClick();
                    }else{
                          JOptionPane.showMessageDialog(null, "Error !");
                           btnClear.doClick();
