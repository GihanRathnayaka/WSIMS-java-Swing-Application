...
float oldQty;
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(txtcusNo.getText().trim().equals("")||TxtName.getText().trim().equals("")||txtendUnits.getText().trim().equals("")||txtReadby.getText().trim().equals("")||Mdate.getCalendar()==null){
            ...
            try {
                ...
                if(result){
                    JOptionPane.showMessageDialog(null, "Customer "+mMonth.getName()+" Water Use Recorded !");
                    btnClear.doClick();
                }else{
 ...
 int i= tblconsuption.getSelectedRow();
        ...
        mMonth.setMonth(Integer.parseInt(model.getValueAt(i, 6).toString()));
   ...
   if(txtcusNo.getText().trim().equals("")||TxtName.getText().trim().equals("")||txtendUnits.getText().trim().equals("")||txtReadby.getText().trim().equals("")||Mdate.getCalendar()==null){
       ...
       try {
           ...
           if(result){
               JOptionPane.showMessageDialog(null, "Updated Rcord !");
               btnClear.doClick();
           }
       } catch (ClassNotFoundException | SQLException ex) {
              JOptionPane.showMessageDialog(null, ex);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            if(result){
                JOptionPane.showMessageDialog(null,"Remove Water Consuption !");
                btnClear.doClick();;
            }else{
            JOptionPane.showMessageDialog(null,"Error !");
            }
