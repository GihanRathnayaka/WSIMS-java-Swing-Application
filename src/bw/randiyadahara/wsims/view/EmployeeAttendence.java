...
public class EmployeeAttendence extends javax.swing.JFrame {
   ...
   public EmployeeAttendence(int UserID) {
    ...
    private void initComponents() {
        ...
        ycYear.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtEmpId, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txtName, javax.swing.GroupLayout.PREFERRED_SIZE, 662, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                        .addComponent(mcMonth, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(jLabel5, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                        .addComponent(ycYear, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txtAttenID, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        txtSearchMonth.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N

        txtSearchYear.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel10Layout.createSequentialGroup()
                ...
                .addGap(10, 10, 10)
                .addComponent(txtSearchYear, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel11, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(txtSearchMonth, javax.swing.GroupLayout.PREFERRED_SIZE, 80, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel3)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(sDate, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPanel10Layout.setVerticalGroup(
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(txtSearchYear, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        .addGap(23, 23, 23)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(txtSearchMonth, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
  ...
  int i= tblAttendence.getSelectedRow();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        try {
            ...
            btnClear.doClick();
            if(result){
            JOptionPane.showMessageDialog(null,"Attendence Record Deleted !");
            }else{
            JOptionPane.showMessageDialog(null,"Error !");
            }
        } catch (ClassNotFoundException | SQLException ex) {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(txtSearchYear.getText().trim().equals("")&&txtSearchMonth.getText().trim().equals("")&&sDate.getCalendar()==null){
            
            String empNo =txtSearchID.getText();
        ...
        }else if( !txtSearchYear.getText().trim().equals("")&&txtSearchMonth.getText().trim().equals("")&&sDate.getCalendar()==null){
        
                String empNo =txtSearchID.getText();
                int year =Integer.parseInt(txtSearchYear.getText());
              
             try {
                 allAttendence=EmployeeAttendenceControler.SearchAttendence(empNo,year);
             } catch (ClassNotFoundException | SQLException ex) {
                 Logger.getLogger(EmployeeAttendence.class.getName()).log(Level.SEVERE, null, ex);
             }
             ...
             try {
                 allAttendence=EmployeeAttendenceControler.SearchAttendence(empNo,year,month);
             } catch (ClassNotFoundException | SQLException ex) {
                 Logger.getLogger(EmployeeAttendence.class.getName()).log(Level.SEVERE, null, ex);
             }
             ...
             try {
                 allAttendence=EmployeeAttendenceControler.SearchAttendence(empNo,year,month,date);
             } catch (ClassNotFoundException | SQLException ex) {
                 Logger.getLogger(EmployeeAttendence.class.getName()).log(Level.SEVERE, null, ex);
             } 
             ...
             try {
                 allAttendence =EmployeeAttendenceControler.getAllAttendenceRecord();
             } catch (ClassNotFoundException | SQLException ex) {
                 Logger.getLogger(EmployeeAttendence.class.getName()).log(Level.SEVERE, null, ex);
             }
